...
class UploadHandler
{
   ...
   */
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        if ( $_REQUEST['frm_origem']=='anuncio' ) {
            //.. anuncios
            $dir_fotos = str_replace( 'cadastro/server/php', '', dirname(__FILE__) );
            $dir_fotos .= 'fotos/';
            $max_number_of_files=3;
            $_crop = true;
        }
      
        if ( $_REQUEST['frm_origem']=='servico' ) {
            //.. serviços
            $dir_fotos = str_replace( 'cadastro/server/php', '', dirname(__FILE__) );
            $dir_fotos .= 'fotos_servico/';
            $max_number_of_files=3;
            $_crop = false;
        }
        ...
        $this->options = array(
            ...
            'upload_dir' =>  $dir_fotos,
            'upload_url' =>  $dir_fotos,
   ...
   protected function get_upload_path($file_name = null, $version = null) {
      ...
      if($_SESSION['acao']=='inclusao') {
        ...
        if (empty($version)) {
            $version_path = $id_anuncio.'/';            
        } else {
            $version_dir = @$this->options['image_versions'][$version]['upload_dir'];            
            if ($version_dir) {
                return $version_dir.$this->get_user_path().$file_name;
            }
            $version_path = $id_anuncio.'/'.$version.'/';
        }
   ...
   /*
   * 
   * Exibe os arquivos da pasta: /fotos/
   *  moises
   */
