...
//.. se tentar preencher o campo categoria sem prencher o tipo - alerta o usuario
$( "#frm_categoria" ).click(function(event) {
   limpa_div_mens();
   _tipo = $('#frm_tipo_anuncio').val();
   if ( _tipo=='undefined' || _tipo=='' ) {
      $('#div_mens_0').append( 'Por favor, primeiramente, selecione o Tipo*'+'<br>' );   
   }
});
...
function validar_submit() {
   ...
   if ( _categoria=='undefined' || _categoria=='' ) {
      resultado = false;
      $('#div_mens_1').append('Por favor, preencha o Campo Categoria*'+'<br>' );
   }
   ...
   if ( _codigo_categoria=='cao' || _codigo_categoria=='gato' ) {
      if ( _raca=='' ) {
         resultado = false;
         $('#div_mens_1').append('Por favor, prencha o campo: Raça*'+'<br>' );
      }
   }
