(function($) {
    ...
    $(document).on('keyup', '.fs-search input', function(e) {
        ...
        if ('' != keywords) {
            ...
            $wrap.find('.fs-option').each(function() {
                ...
                // alterei para ignorar acentos na busca
                nome_digitado  = remover_acentos( keywords );
                nome_procurado = remover_acentos( $(this).find('.fs-option-label').text() );
               
                if (null === nome_procurado.match(nome_digitado)) {
    ...
    function remover_acentos( newStringComAcento ) {
