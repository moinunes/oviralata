...
<body class="fundo_cinza_1">
   ...
   function exibir_formulario() {
      ...
      <form id="frmCadastroTipo" class="form-horizontal" action="cadastro_tipo.php" method="POST" enctype="multipart/form-data" role="form">
         ...
         <div class="row">
             <div class="col-12 altura_linha_1 fundo_azul_claro"></div>
         </div>

         <div class="row text-right fundo_azul_claro border">
            <div class="col-12">
   ...
   function igualar_formulario() {
      ...
      if ( $_REQUEST['acao']=='inclusao' ) {
         ...
         $_REQUEST['frm_modo'] = '<< NOVO - Tipo de imóvel >>';
      
      } else if ( $_REQUEST['acao']=='alteracao' ) {
         $_REQUEST['frm_modo'] = '<< Alterar - Tipo de imóvel >>';

      } else if ( $_REQUEST['acao']=='exclusao' ) {
         $_REQUEST['frm_modo'] = '<< Excluir - Tipo de imóvel >>';
      
      } else {
         die(' Contate o programador.' );
      }
