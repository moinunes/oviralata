...
if ( isset($_SESSION['servico_lista_ou_galeria']) ) {
   if ( $_SESSION['servico_lista_ou_galeria'] == 'L' ) {
...
//   if ( $_REQUEST['comportamento'] == 'exibir_lista' ) {
...
<head>
   ...
   <script src="./dist/js/servico_galeria.js"></script>
   ...
   <header id="header">
    ...
    <style type="text/css">
      ...
      <div class="container-fluid">
         <form id="frmAdotar" class="form-horizontal" action="servico_galeria.php" method="POST" role="form">
            ...
            <div class="row fundo_branco_1">            
               <div class="col-12 text-center">
                  <a href="servico.php"><img src="./images/servico.png" alt='adote um pet, cachorro, gato ou outro animal de estimação'></a>  
               </div>   
            </div>
      ...
      <div class="row fundo_branco_1">         
         ...
         <div class="col-lg-3 col-xl-3 d-none d-lg-block">
            ...
            <div class="row margem_pequena">   
               ...
               <div class="col-12 altura_linha_2"></div>
               <div class="col-12">
                  <?php  Utils::exibir_anuncio_aleatorio( 'doacao', 'Amiguinhos para Adoção,<br> A q u i !', '#fafafa'); ?>
                  <br>
               </div>
            </div>
            <div class="row">   
         ...
         <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6" >
            ...
            <div class="row shadow p-1 mb-1 rounded">
               <div class="col-12 text-center fundo_laranja_0">
                  <?php
                  $instancia = new Carrossel_Servico();
                  $instancia->id_carousel          = 'id_servico_galeria';
...
<script type="text/javascript">
   ...
   function exibir_lista_ou_galeria(_this) {
      if ( document.querySelector('input[id="frm_lista_galeria_l"]:checked') ) {
         <?php $_SESSION['servico_lista_ou_galeria'] = 'L';?>
      } else {
         <?php $_SESSION['servico_lista_ou_galeria'] = 'G';?>
      } 
   ...
   $('#id_servico_galeria').carousel({
       pause: true,
       interval: false
   });
  
   function mostrar_detalhes_servico(id_servico) {
      exibir_detalhes_carousel_servico(id_servico);
   }
