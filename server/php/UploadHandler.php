...
class UploadHandler
{
            ...
            */
            ...
            'image_versions' => array(
                ...
                'thumbnail' => array(
                    ...
                    'max_width'  => 50, // either specify width, or set to 0. Then width is automatically adjusted - keeping aspect ratio to a specified max_height.
                    'max_height' => 50 // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                ),
                ...
                'media' => array(
                    ...
                    'no_cache' => true, 
                    // 'strip' => true, (this strips EXIF tags, such as geolocation)
                    'max_width'  => 280, // either specify width, or set to 0. Then width is automatically adjusted - keeping aspect ratio to a specified max_height.
                    'max_height' => 230 // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                )
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        if (empty($version)) {
            $version_path = $id_imovel.'/';            
        } else {
            $version_dir = @$this->options['image_versions'][$version]['upload_dir'];            
            if ($version_dir) {
                return $version_dir.$this->get_user_path().$file_name;
            }
            $version_path = $id_imovel.'/'.$version.'/';
        }
         
        //file_put_contents( 'teste.txt', $this->options['upload_dir'].$this->get_user_path().$version_path.$file_name  ."\n" , FILE_APPEND );
        file_put_contents( 'teste.txt', '==='.$_SESSION['dir_tmp'] ."\n" , FILE_APPEND );
   ...
   /*
   * 
   * Exibe os arquivos da pasta: /server/php/files/
   *  moises
   */
    protected function get_file_objects($iteration_method = 'get_file_object') {
        $upload_dir = $this->get_upload_path();
        
        //.. aqui pega o diretorio 
        //file_put_contents( 'teste.txt', $upload_dir  ."\n" , FILE_APPEND );
    ...
    /*
   * 
   *  Inclui a foto da pasta: /server/php/files/
   *  moises
   */
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
               ...
               if ($append_file) {
                  ...
                  //.. inclui a foto na pasta
                  $file_path = str_replace( ' (1)', '', $file_path ); 
                  file_put_contents( 'teste.txt', $file_path  ."\n" , FILE_APPEND );
   ...
   /*
   * 
   * Exclui a foto da pasta: /server/php/files/
   *  moises
   */
