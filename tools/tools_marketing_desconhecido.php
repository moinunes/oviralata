...
<body>
   ...
   <div class="container">
      ...
      <div class="row fundo_laranja_1">
         <div class="col-12">
            <span class="destaque_1">Marketing-Desconhecidos</span>
            <br><br>
         </div>         
         <div class="col-6">
             <a class="link_a" href="tools_enviar_email_desconhecido.php?acao=alteracao&comportamento=exibir_listagem" role="button">Enviar-E-mail</a>
         </div>
         
         <div class="col-6">
             <a class="link_a" href="tools_enviar_email_desconhecido.php?acao=alteracao&comportamento=invalidar_emails" role="button">Invalidar E-mail</a>
         </div>         
         <div class="col-6">   
             <a class="link_a" href="tools_upload_email_desconhecido.php?acao=inclusao&comportamento=exibir_formulario" role="button">Adicionar  E-mails</a>
         </div>
         <div class="col-6">   
             <a class="link_a" href="tools_enviar_email_desconhecido.php?acao=inclusao&comportamento=listar_enganjamento" role="button">Listar enganjamento</a>
         </div>
